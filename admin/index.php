  ...
  <div class="admin-container" id="adminContainer">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav>
        <ul>
          ...
          <li><a href="approve_teachers.php"><i class="fas fa-user-check"></i> Approvals</a></li>
    ...
    <div class="main-content">
      ...
      <main class="dashboard">
        ...
        <p>Manage users, classes, and content.</p>
      </main>
  ...
  <div class="admin-container" id="adminContainer">
    ...
    <div class="main-content">
      ...
      <main class="dashboard">
        ...
        switch ($page) {
          case 'approve':
              include 'pages/approve_teachers.php';
              break;
          case 'teachers':
              include 'pages/teachers_list.php'; // Optional: Create this for full list
              break;
          default:
